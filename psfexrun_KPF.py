...
def pixelscale(i):
	...
	hdrfix(i, 'PSCALE', round(pixscale, 3),comment="Pixel scale arcse/pix")
...
def psfex(i):
	...
	os.system(psfexcom)
	os.system('rm '+fn+'.cat')
	psfex_result = psfexxml(fn+'.psfex.xml')
	print (i, ' fwhm value is ', psfex_result)
	hdrfix(i,'PSF_FWHM',round(psfex_result[1],3),comment='PSFEX PSF size in pixel')
